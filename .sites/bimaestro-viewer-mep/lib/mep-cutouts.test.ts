...
describe('wall-only cutouts', () => {
  it('cuts both walls within depth, preserves floors and walls beyond the volume', () => {
    ...
    expect(volume(triangleSubset(mesh.geometry, id => id === 4))).toBeCloseTo(100, 3);
