...
namespace Licensing
{
    internal class UsageEvent
    {
        ...
        // facultatif: si tu veux surcharger par event (non requis grâce au body)
    ...
    public static class Telemetry
    {
            ...
            string fallbackLicenseKey = null)
        {
            ...
            var root = Path.Combine(appData, "BIMaestro", "Telemetry");
            Directory.CreateDirectory(root);
            _queueFile = Path.Combine(root, "usage_queue.json");
        ...
        private static async Task SafeFlushAsync()
        {
            ...
            try
            {
                // On met aussi license_key au top-level pour fallback côté Edge
