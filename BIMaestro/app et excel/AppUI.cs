...
public class AppUI : IExternalApplication
{
    ...
    public static void CreateRibbonUI(UIControlledApplication application)
    {
       ...
       // RibbonPanel panelTest = application.CreateRibbonPanel(tabName, "Panneaux réservés au test");
        ...
        AddPushButton(panelVisualization, "Sélection d'objet", "Sélection\nd'objet", assemblyPath, "Visualisation.SelectSimilarCommand", "Sélection d'élément.png", "Permet la sélection d'éléments en particulier");
        ...
        AddSplitButton(panelEditing, "Bride auto", "Bride\nauto", assemblyPath,
            ...
            {
                ("Bride auto", "Bride\nauto", "Modification.AddFlangesAtEnds", "bride auto.png",""),
                ("Choix bride", "Choix\nbride", "Modification.PickDefaultFlange", "safeimagekit-bouton reset4.png","")
            });
        ...
        AddPushButton(panelEditing, "GestionExcelCmd", "Gestion\nExcel", assemblyPath, "Modification.ExcelScheduleCommand", "export import Excel.png", "Exporter ou importer une nomenclature au format Excel");
        AddPushButton(panelEditing, "Purge du plan", "purge du\nplan", assemblyPath, "Modification.CombinedCleanupCommand", "purge.png", "Corrige automatiquement les fautes d'orthographe et de grammaire dans les textes visibles sur les vues ou feuilles du projet. \r\nL'IA analyse les textes scannés par chunk et indique les erreurs ligne par ligne avec explication. \r\nLes corrections sont classées en \"Mineur\" (ponctuation, espaces) ou \"Erreur\" (grammaire, orthographe).\r\n");
        AddPushButton(panelEditing, "Auto canalisation", "Auto\ncanalisation", assemblyPath, "BIMaestro.Routing.ConnectPipesCommand", "cana auto.png", "Permet la sélection d'éléments en particulier");
        ...
        AddSplitButton(panelCouleur, "Changement de couleur", "couleur\nOui/Non", assemblyPath,
            new List<(string buttonName, string buttonText, string className, string resourceImageName, string toolTip)>
            {
                ("couleur de projet", "couleur\nOui/Non", "Couleur.ToggleCombinedColoringCommand", "bouton lumière.png",""),
                ("couleur de maquette", "couleur reset", "Couleur.ResetTabItemRandomColorsCommand", "safeimagekit-bouton reset4.png","")
            });        
        AddPushButton(panelCouleur, "papa Noël", "papa Noël", assemblyPath, "Couleur.PapanoelCommand", "Père Noël.png", "Fait apparaître des couleurs comme des guirlandes\nDouble clic pour revenir à la normale.\n\nAttention désactiver <couleur Oui/Non> avant activation.");
        ...
        AddPushButton(panelAnalysis, "Temp par projet", "Temps par\nprojet", assemblyPath, "BIMaestro.Dashboard.ShowTimeDashboard", "analyse de temps.png", "Permet la sélection d'éléments en particulier");
        AddPushButton(panelVisualization, "Chek 3D", "chek 3D", assemblyPath, "BIMastro.SmartCheck.SmartCheckCommand", "correction 3D.png", "Permet la sélection d'éléments en particulier");
