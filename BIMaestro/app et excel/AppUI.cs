...
public class AppUI : IExternalApplication
{
    ...
    public static void CreateRibbonUI(UIControlledApplication application)
    {
        ...
        AddPushButton(panelAnalysis, "Check 3D", "Check 3D", assemblyPath, "Analyse.SmartCheckCommand", "correction 3D.png", "Vérifie les éléments 3D sélectionnés pour détecter les incohérences.");
